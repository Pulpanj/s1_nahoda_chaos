...
draft: false
categories: ["Informační entropie", "Přednáška 8"]
# image: "image.jpg"
pdflink: "[![PDF](images/pdf_icon.png){width=60px}](posts/p8_information_entropy/co_je_to_bit.pdf) "
...
## Hádání výsledku pokusu při shodných pravděpodobnostech všech výsledků
...
# Příklady výpočtů informační entropie {#fce_entropy}
...
rovna $Q_{random}=log_2(26^{100})=100 \cdot log_2(26)$
