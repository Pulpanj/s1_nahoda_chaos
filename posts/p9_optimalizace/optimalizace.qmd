...
t.j. můžeme zobrazovat rovnici jako Quarto markdown:
```{julia}
#| echo: fenced
#| output: asis
#| code-fold: false
...
vymalovat $S$ čtverečních metrů stěn bazénu. Zadání (optimalizace) zní: nalézt
rozměry bazénu $x,y,h$ (délka,šířka,hloubka), tak aby objem bazénu byl co
největší při použití barvy jen ze sudu obsahujícím barvu jen pro plochu $S$.
