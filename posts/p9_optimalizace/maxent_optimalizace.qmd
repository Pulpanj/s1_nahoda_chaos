...
\frac{\partial}{\partial p_j}\, \big(p_i \cdot log_2(p_i) \big)\\
    ...
    \big) \\
    -\frac{\partial}{\partial p_j}\, \big( p_(p_1,\dots,p_{N-2}) \cdot log_2(p_N(p_1,\dots,p_{N-2}))\big)
\end{align}
$$
...
## Grafy rovnovážné pravděpodobnosti pro falešnou kostku
...
plot(plots...,
    ...
    linecolor=[:red :purple :orange :green :pink :blue],
    left_margin=[5mm 5mm],
)
```
