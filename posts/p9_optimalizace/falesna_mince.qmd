...
Kolik tribitů obsahuje výsledek pokusu (1 falesna mince z 12 )?
...
::: {.callout-tip title="Otázka na závěr ?" icon=false color=green}

Lze napsat program, který najde  sekvenci vážení i v případě obecného zadání K falešných mincí mezi N mincemi ?
